...
def is_sweltering():
    ...
    temp= int(input('What is the current temperature(in Farenheit)?'))
...
def is_warm():
    ...
    """
    # write your code for this function below this line.
    temp= int(input('What is the current temperature (Farenheit)?'))
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    humidity= input("Is it currently humid?")
    if humidity == "yes":
      return True
    else:
        return False
